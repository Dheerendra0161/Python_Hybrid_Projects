...
class TestHealthInsuranceOpted:
    ...
    def test_selecting_insurance_plan_company(self, setup_and_teardown, logger):
        choose_health_insurance_company = CompaniesHealthInsuranceQuotesPage(setup_and_teardown, logger)
